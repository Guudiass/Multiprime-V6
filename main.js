...
const REMOTE_HASH_SOURCES = {
    'main.js': 'https://raw.githubusercontent.com/Guudiass/Multiprime-V6/main/main.js',
    'preload.js': 'https://raw.githubusercontent.com/Guudiass/Multiprime-V6/main/preload.js',
    'preload-secure.js': 'https://raw.githubusercontent.com/Guudiass/Multiprime-V6/main/preload-secure.js',
    'preload-toolbar.js': 'https://raw.githubusercontent.com/Guudiass/Multiprime-V6/main/preload-toolbar.js',
    'toolbar.html': 'https://raw.githubusercontent.com/Guudiass/Multiprime-V6/main/toolbar.html'
};
...
const filesToUpdate = [
    {
        url: addTimestamp('https://raw.githubusercontent.com/Guudiass/Multiprime-V6/main/main.js'),
        dest: path.join(__dirname, 'main.js'),
        critical: true,
        backupUrls: [addTimestamp('https://designerprime.com.br/wp-content/uploads/2025/cookies/V6/main.js')]
    },
    {
        url: addTimestamp('https://raw.githubusercontent.com/Guudiass/Multiprime-V6/main/preload.js'),
        dest: path.join(__dirname, 'preload.js'),
        critical: true,
        backupUrls: [addTimestamp('https://designerprime.com.br/wp-content/uploads/2025/cookies/V6/preload.js')]
    },
    {
        url: addTimestamp('https://raw.githubusercontent.com/Guudiass/Multiprime-V6/main/preload-secure.js'),
        dest: path.join(__dirname, 'preload-secure.js'),
        critical: true,
        backupUrls: [addTimestamp('https://designerprime.com.br/wp-content/uploads/2025/cookies/V6/preload-secure.js')]
    },
    {
        url: addTimestamp('https://raw.githubusercontent.com/Guudiass/Multiprime-V6/main/preload-toolbar.js'),
        dest: path.join(__dirname, 'preload-toolbar.js'),
        critical: true,
        backupUrls: [addTimestamp('https://designerprime.com.br/wp-content/uploads/2025/cookies/V6/preload-toolbar.js')]
    },
    {
        url: addTimestamp('https://raw.githubusercontent.com/Guudiass/Multiprime-V6/main/toolbar.html'),
        dest: path.join(__dirname, 'toolbar.html'),
        critical: true,
        backupUrls: [addTimestamp('https://designerprime.com.br/wp-content/uploads/2025/cookies/V6/toolbar.html')]
    }
];
